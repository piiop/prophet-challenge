# prophet-challenge
This is my submission for Module 8 Challenge. This contains starter code and a
dataset provided by the Bootcamp. Coding was also done with Gemini AI assitant
in Google Colab.
